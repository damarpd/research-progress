...
- **Rationale**: A study from 2018 highlighted that SFM studies were limited for pedestrian in normal behavior using pedestrian facilities, considering pedestrian characteristics such as age, gender, and so forth, <mark>as SFM usually considered in evacuation situations or panic situations. </mark>
...
- This study proposed the improved model integrates three key mechanisms: <mark>a restricted 120° forward visual field, group-type classification based on social relationships, and an exponentially formulated inter-group repulsive force.
...
- **Data collection method**: a video camera positioned on the second floor building (approx 6 m above ground level) which headed to bi-directional straight passage between two gates of the commercial street at Wanda Plaza, Nanchang City (which determined as outdoor ground-level walkway).
