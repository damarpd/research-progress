...
Additionally, while most existing studies have specifically focussed on examining passengers movements associated with entering and exiting vehicles, during the boarding and alighting process ([Qu Y., et.al.,2019](https://doi.org/10.1016/j.physa.2019.121075), [Seriani and Fernandez, 2015](https://doi.org/10.1016/j.trc.2015.02.003)), at this moment only [Yining Jia, et.al.,2026](https://doi.org/10.1016/j.physa.2026.131279) that consider three passenger categorization taking into passenger dynamics account , this study shifts attention to the dynamics of remaining on-board passengers as part of **adaptation mechanism**. Investigating such behavior is essential, as on-board passengers adjustments may significantly influence overall passenger flow and operational efficiency. 
