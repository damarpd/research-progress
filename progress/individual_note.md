...
- The order degree explains why boarding headway dominates the overall pattern: at intermediate order, boarding passengers are repeatedly interrupted by alighting passengers crossing their path, forcing them to wait longer; at high order, boarding can proceed more continuously once alighting finishes, shortening their gaps — confirming boarding headway as the **dominant factor** behind the overall headway pattern [Qu et al (2019)](https://doi.org/10.1016/j.physa.2019.121075).
- Alighting behavior stays largely **unaffected by the crowd's order degree**: their strong intrinsic urgency (a missed stop forces a costly return trip, $t_2 \gg t_1$) keeps their pace consistent regardless of external crowd conditions — meaning the non-linear pattern observed is driven entirely by boarding behavior, not alighting behavior [Qu et al (2019)](https://doi.org/10.1016/j.physa.2019.121075).
- Larger burst sizes consistently improve both order degree and flow efficiency, confirming the **"first alight" rule** as an effective crowd management strategy — by separating alighting and boarding passengers into larger, uninterrupted bursts, mutual interference is reduced and both safety and throughput at the bottleneck improve [Qu et al (2019)](https://doi.org/10.1016/j.physa.2019.121075).
